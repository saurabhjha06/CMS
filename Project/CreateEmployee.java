...
/*
 * Created by JFormDesigner on Fri Feb 26 23:59:21 IST 2016
 */
...
public class CreateEmployee {
	...
	private void UploadImgMouseClicked() {
		// TODO add your code here
	}
	...
	private void initComponents() {
		...
		//======== rootPanel ========
		{
			rootPanel.setBackground(new Color(42, 146, 119));
			...
			//======== scrollPane1 ========
			{
				...
				//======== employeeRegPanel ========
				{
					...
					//======== contactInfoPanel ========
					{
						...
						//======== addressPanel ========
						{
							...
							addressPanel.add(label3);
							label3.setBounds(690, 95, 11, 25);
					...
					contactInfoPanel.setBounds(10, 235, 960, 255);
					...
					//======== empPhoto ========
					{
						...
						UploadImg.setIcon(new ImageIcon("E:\\Project\\Image\\2.png"));
						UploadImg.setForeground(Color.white);
						UploadImg.setFont(new Font("Times New Roman", Font.PLAIN, 20));
						UploadImg.addMouseListener(new MouseAdapter() {
							@Override
							public void mouseClicked(MouseEvent e) {
								UploadImgMouseClicked();
							}
						});
						empPhoto.add(UploadImg);
						UploadImg.setBounds(20, 175, 195, 40);
						empPhoto.add(label1);
						label1.setBounds(15, 30, 190, 140);
					...
					empPhoto.setBounds(715, 15, 225, 220);
					...
					credentialsPanel.setBounds(10, 495, 960, 295);
					...
					employeeRegPanel.add(exitBtn);
					exitBtn.setBounds(705, 810, 140, 50);
					...
					employeeRegPanel.add(saveBtn);
					saveBtn.setBounds(45, 805, 140, 50);
				...
				scrollPane1.setViewportView(employeeRegPanel);
			}
			rootPanel.add(scrollPane1);
			scrollPane1.setBounds(5, 5, 980, 665);
